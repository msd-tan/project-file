...
async def wakeup():
    await download_website_data()
    await successMessage()


async def successMessage():
    message = "file has been downloaded!"
    print("This is the successMessage", message)


@app33.get("/download")
async def download_website_data():
    url = "https://www.sigsauer.com/spear.html"
...
if __name__ == '__main__':
    uvicorn.run(app='testfetchanddownload:app33', host="127.0.0.1", port=8371, reload=True)
